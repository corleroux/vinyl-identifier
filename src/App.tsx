...
const ConditionGradeScreen = lazy(() =>
  import('@/screens/ConditionGradeScreen').then((m) => ({ default: m.ConditionGradeScreen })),
)
      ...
      <main id="main-content" className={showNav ? 'pb-16' : ''}>
        <Suspense fallback={<LoadingFallback />}>
          <Routes>
            ...
            <Route path="/grade-condition" element={<ConditionGradeScreen />} />
          </Routes>
        </Suspense>
      </main>
      {showNav && <BottomNav />}
